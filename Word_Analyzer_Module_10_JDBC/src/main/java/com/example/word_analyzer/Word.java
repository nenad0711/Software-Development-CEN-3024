/**
 * This class contains Word elements and its attributes from the MySql database given for analysis via MainController
...
/**
 * Word class contains Word elements and its attributes from the MySql database given for analysis via MainController
 */
public class Word {
    String name;
    Integer freq;
